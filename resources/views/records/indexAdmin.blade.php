                                        ...
                                        <select class="form-control" name="user_filter">
                                            ...
                                            @foreach($users as $user)
                                                <option value="{{$user->id}}"
                                                        @if($user_filter == $user->id) selected @endif>{{$user->name}}</option>
                                            @endforeach
                        ...
                        <section>
                            <table class="table table-bordered table-hover" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:7%">負責業務</th>
                                ...
                                @foreach ($records as $record)
                                    ...
                                    <tr  class="text-center">
                                        ...
                                        <td class="align-middle " style="vertical-align: middle">{{ $record->user->name  }}</td>

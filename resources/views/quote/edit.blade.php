    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <!--------------------------
              ...
              -------------------------->
            <div class="container">
                <form class="well form-horizontal" action="{{route('quote.update',$quote->id)}}" method="post">
                    @csrf
                    @if ($errors->any())
                            ...
                            <div class="col-md-6 inputGroupContainer">
                                ...
                                <div class="input-group">
                                    ...
                                    <script>
                                        ...
                                        product_select[0].selectize.setValue({{$quote->product->id}});
                                    </script>
                                </div>
